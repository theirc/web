		...
		return (
			<Skeleton headerColor='light'>
				<div className="SkeletonContainer">
					<Placeholder>
						<ArticleDetailBody key={"ArticleDetailBody"} country={country} direction={direction} category={category} other={other} article={article} loading={loading} onNavigate={onNavigate} />
